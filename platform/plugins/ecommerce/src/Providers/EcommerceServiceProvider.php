...
use Botble\Ecommerce\Repositories\Caches\OrderProductImagesCacheDecorator;
...
use Botble\Ecommerce\Repositories\Eloquent\OrderProductImagesRepository;
...
class EcommerceServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->bind(OrderProductImagesInterface::class, function () {
            return new OrderProductImagesCacheDecorator(
                new OrderProductImagesRepository(new OrderProductImages)
            );
        });
