...
Route::group(['namespace' => 'Botble\Ecommerce\Http\Controllers\Fronts', 'middleware' => ['web', 'core']], function () {
    Route::group(apply_filters(BASE_FILTER_GROUP_PUBLIC_ROUTE, []), function () {
        ...
        Route::post('products/crop-images', [
            'as'   => 'crop-images',
            'uses' => 'PublicProductController@cropImages',
        ]);
        Route::get('dowload-order-images/{orderID}/{productID}/{orderProductID}', [
            'as'   => 'dowload-order-images',
            'uses' => 'PublicProductController@dowloadOrderImages',
        ]);
		
		Route::post('products/update-custom-attributes-price', [
            'as'   => 'update-custom-attributes-price',
            'uses' => 'PublicProductController@updateCustomAttributesPrice',
        ]);
		Route::post('products/update-wall-mural-price', [
            'as'   => 'update-wall-mural-price',
            'uses' => 'PublicProductController@updateWallMuralPrice',
        ]);
    });
