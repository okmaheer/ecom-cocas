...
<html lang="{{ app()->getLocale() }}">
    ...
    <header class="header_wrap @if (theme_option('enable_sticky_header', 'yes') == 'yes') fixed-top header_with_topbar @endif">
            ...
            <div class="container">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="d-flex align-items-center justify-content-center justify-content-md-start">
                            ...
                            <ul class="contact_detail text-center text-lg-left">
                                ...
                                <li>
                                    <!--<i class="ti-mobile"></i>-->
                                    <span>{{ theme_option('hotline') }}</span></li>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="d-none d-flex align-items-center justify-content-center justify-content-md-end">

                            @if (is_plugin_active('ecommerce'))

                                <?php /*?>@php $currencies = get_all_currencies(); @endphp
                                ...
                                <ul class="header_list">
                                    ...
                                    <?php /*?><li><a href="{{ route('public.compare') }}"><i class="ti-control-shuffle"></i><span>{{ __('Compare') }}</span></a></li><?php */?>

                                    @if (!auth('customer')->check())

										<li><a href="{{ route('customer.register') }}"><i class="ti-user"></i><span>{{ __('Register') }}</span></a></li>
        ...
        <div class="middle-header dark_skin">
            ...
            <div class="container">
                ...
                <div class="nav_block">
                    ...
                    <div class="contact_phone order-md-last" style="font-size: 15px;">
                        <span>
                        @if(!empty(setting('ecommerce_store_phone')))  Call Us On : {{ setting('ecommerce_store_phone') }}<br /> @endif
                        @if(!empty(theme_option('email')))  Email : {{ theme_option('email') }}<br /> @endif
        ...
        <div class="bottom_header light_skin main_menu_uppercase @if (url()->current() === url('')) mb-0 @endif">

            <div class="container">

                <div class="row">

                    <div class="col-lg-3 col-md-4 col-sm-6 col-4 d-sm-none">
